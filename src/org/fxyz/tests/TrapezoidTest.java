...
public class TrapezoidTest extends Application {
    ...
    private void generateShapes() {
        for (int i = 0; i < 50; i++) {
            ...
            double randomSmallSize = (r.nextDouble() * 50) + 10;
            double randomBigSize = (r.nextDouble() * 100) + 50;
            double randomHeight = (r.nextDouble() * 50) + 25;
            double randomDepth = (r.nextDouble() * 50) + 25;
