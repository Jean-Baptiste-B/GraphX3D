...
public class SphereSegmentTest extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        for(int i=0;i<30;i++){
            ...
            float randomRadius = (r.nextFloat() * 150) + 10;
            float randomThetaMax = (r.nextFloat() * 360) + 1;
            float randomThetaMin = (r.nextFloat()) + 1;
            if(randomThetaMin > randomThetaMax) {
                float swap = randomThetaMin;
                randomThetaMin = randomThetaMax;
                randomThetaMax = swap;
            }
            float randomPolarMax = (r.nextFloat() * 90) + 1;
            float randomPolarMin = (r.nextFloat()) + 1;
